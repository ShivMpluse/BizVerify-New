...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "BizVerify — Verify Your Domain, Build Trust" },
      { name: "description", content: "Verify your website domain and display a trusted business badge with BizVerify." },
      { property: "og:title", content: "BizVerify — Verify Your Domain, Build Trust" },
      { property: "og:description", content: "Verify your website domain and display a trusted business badge." },
